...
import (
	...
	circuit "github.com/archoncloud/archon-dht/mods/go-libp2p-circuit-mod"

	discovery "github.com/libp2p/go-libp2p-discovery"
	swarm "github.com/libp2p/go-libp2p-swarm"

	tptu "github.com/archoncloud/archon-dht/mods/go-libp2p-transport-upgrader-mod"
...
func (cfg *Config) NewNode(ctx context.Context) (host.Host, error) {
	...
	upgrader.PermissionLayer = cfg.PermissionLayer
	if cfg.Insecure {
