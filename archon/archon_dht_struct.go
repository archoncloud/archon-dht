...
// Called by sp to broadcast to dht contentID:{url, versionData}, so that
// downloaders, given contentID, can regtrieve the (download)url.
// The versionData is input to a preference function on routing. i.e. archon's
// versioning system
